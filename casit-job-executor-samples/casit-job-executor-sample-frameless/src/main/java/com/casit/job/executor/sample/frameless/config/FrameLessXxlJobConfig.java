package com.casit.job.executor.sample.frameless.config;

import com.casit.job.executor.sample.frameless.jobhandler.SampleXxlJob;
import com.casit.job.core.executor.impl.XxlJobSimpleExecutor;
